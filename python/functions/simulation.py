...
def simulate_battery_life(battery, input_timeseries: dict, simulation_years: float = None, is_constant_input: bool = False):
    ...
    if is_constant_input:
        ...
        if t_secs[-1] < simulation_years*365*24*3600:
            ...
            n_tile = np.ceil((simulation_years*365*24*3600)/t_secs[-1])
            ...
            temperature = np.tile(temperature)
        ...
        simulation_breakpoints = find_breakpoints(t_secs, EFCs, idx_turning_point)
